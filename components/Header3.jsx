      ...
      <div className=" p-5">
        ...
        <div className="flex justify-center my-5 mx-20 ">
          <input
            type="text"
            placeholder="Search..."
            className=" w-6/12  h-12 outline-none px-3 text-lg border-r-2 border-gray-400 "
          ...
          <button
            type="submit"
            className=" h-12 px-3 py-2 w-72 bg-green-400 hover:cursor-pointer hover:bg-green-600 text-white text-xl"
          >
        ...
        <div className="flex mx-20 my-5 font-bold">
          ...
          <button
            type="submit"
            className=" h-12 px-3 py-2 hover:cursor-pointer border-2 border-white text-white mr-5 hover:bg-gray-500 rounded-xl"
          >
